    ...
    return (
        <main className={style_trabajos.pagTrabajo_detalle_container}>
            <div className={style_trabajos.pagTrabajo_layout}>
                ...
                <section
                    className={style_trabajos.pagTrabajo_hero}
                ...
                >
                    <div className={style_trabajos.pagTrabajo_hero_content}>
                        <div className={style_trabajos.pagTrabajo_hero_badges}>
                            ...
                            <span className={style_trabajos.pagTrabajo_badge}>
                                {tra.categoria_trabajo}
                            </span>
                        ...
                        <h1
                            id="trabajo-title"
                            className={style_trabajos.pagTrabajo_detalle_h1}
                        >
                            {tra.nombre_trabajo}
                        </h1>

                        <p className={style_trabajos.pagTrabajo_hero_intro}>
                            {tra.resumen_trabajo}
                        </p>
                    ...
                    <aside
                        className={style_trabajos.pagTrabajo_hero_panel}
                        aria-label="Resumen rápido del proyecto"
                    >
                        <span className={style_trabajos.pagTrabajo_panel_label}>
                            Proyecto
                        </span>
                ...
                <div className={style_trabajos.pagTrabajo_content_grid}>
                    <article className={style_trabajos.pagTrabajo_case_content}>
                        <section
                            className={style_trabajos.pagTrabajo_section}
                        ...
                        {tra.reto_tecnico && (
                            ...
                            >
                                ...
                                <h2
                                    ...
                                    className={style_trabajos.pagTrabajo_h2}
                                >
                                    Principal desafío del desarrollo
                                </h2>
                    ...
                    <aside className={style_trabajos.pagTrabajo_sidebar}>
                        <section
                            className={style_trabajos.pagTrabajo_sidebar_card}
